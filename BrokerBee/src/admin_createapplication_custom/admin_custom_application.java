package admin_createapplication_custom;
...
public class admin_custom_application {
	...
	public void CreateAPP() throws InterruptedException {
		...
		Password.sendKeys("Zeus#1066!");

		driver.findElement(By.cssSelector("button[type='submit']")).click();

		String Title = "myBrokerBee Admin - Applications - myBrokerBee";
		String GetTitle = driver.getTitle();
		AssertJUnit.assertEquals(Title, GetTitle);
		if ("myBrokerBee Admin - Applications - myBrokerBee".equals(Title)) {

			driver.findElement(By.xpath("//*[@id=\"toolbar-main\"]/a[1]")).click();

			String Title1 = "myBrokerBee Admin - Applications - myBrokerBee";
			String GetTitle1 = driver.getTitle();
			AssertJUnit.assertEquals(Title1, GetTitle1);
			if ("myBrokerBee Admin - Applications - myBrokerBee".equals(Title1)) {
...
//			wait1.until(ExpectedConditions.elementToBeClickable(By.id("ltv_options"))).click();
			...
			wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div/div/div/div/div/div[2]/span/button"))).click();
