...
public class CreateApplicationAgent {
	...
	public void CreateAPP() throws InterruptedException {
		...
		driver.get("https://myb-274-d.mybrokerbee.com/app/Login.php");
		driver.manage().window().maximize();

		WebElement UserName = driver.findElement(By.name("user_name"));
		UserName.sendKeys("temp_agent");
		...
		if ("myBrokerbee | Dashboard".equals(Title)) {
			...
			String Title1 = "temp agent - Applications - myBrokerBee";
			String GetTitle1 = driver.getTitle();
			AssertJUnit.assertEquals(Title1, GetTitle1);
			if ("temp agent - Applications - myBrokerBee".equals(Title1)) {
